...
public class MsgHandlerTask implements Runnable {
	...
	private TradeProxyOnFuncMsgHandleEnum ctpOnFuncMsgHandleEnum;
	private TradeProxyRespVOBase obj;
	...
	public MsgHandlerTask(long handleTime) {
		this.handleTime = handleTime;
	}

	public void loading(TradeProxyOnFuncMsgHandleEnum ctpOnFuncMsgHandleEnum,
						TradeProxyRespVOBase obj, RespInfoVO respInfoVO,
	...
	private void sendMessage(ByteBuf byteBuf) {
		...
		if (!TradeProxyOnFuncMsgHandleEnum.QRY_TRADING_ACCOUNT.equals(ctpOnFuncMsgHandleEnum)) {
			Gson gson = new Gson();

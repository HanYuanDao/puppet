package com.xinqi.puppet.netty.gateway.tcp.server.proxy.trader.qdp;


import com.google.gson.Gson;
import com.xinqi.puppet.common.DecodeUtils;
import com.xinqi.puppet.common.UserInfoVO;
import com.xinqi.puppet.netty.gateway.tcp.server.MsgHandlerTask;
import com.xinqi.puppet.netty.gateway.tcp.server.TradeProxyMsgHandlerThreadPool;
import com.xinqi.puppet.netty.gateway.tcp.server.TradeProxyOnFuncMsgHandleEnum;
...
import qdp.qdptraderapi.CQdpFtdcInvestorFeeField;
import qdp.qdptraderapi.CQdpFtdcOrderActionField;
import qdp.qdptraderapi.CQdpFtdcOrderField;
...
import qdp.qdptraderapi.CQdpFtdcReqUserLoginField;
import qdp.qdptraderapi.CQdpFtdcRspInfoField;
import qdp.qdptraderapi.CQdpFtdcRspInstrumentField;
import qdp.qdptraderapi.CQdpFtdcRspInvestorAccountField;
import qdp.qdptraderapi.CQdpFtdcRspInvestorPositionField;
import qdp.qdptraderapi.CQdpFtdcRspUserLoginField;
import qdp.qdptraderapi.CQdpFtdcRspUserLogoutField;
import qdp.qdptraderapi.CQdpFtdcRtnAuthenticateField;
import qdp.qdptraderapi.CQdpFtdcTradeField;
import qdp.qdptraderapi.CQdpFtdcTraderApi;
import qdp.qdptraderapi.CQdpFtdcTraderSpi;
 ...
 * @since : 2024/8/26 13:59
 **/
@Slf4j
public class QdpTradeSpiImpl extends CQdpFtdcTraderSpi implements ServletContextListener {
	...
	private TradeProxyMsgHandlerThreadPool ctpMsgHandlerThreadPool;
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		ctpMsgHandlerThreadPool = webApplicationContext.getBean(TradeProxyMsgHandlerThreadPool.class);
	}

	public QdpTradeSpiImpl(CQdpFtdcTraderApi traderApi, UserInfoVO userInfoVO) {
		this.traderApi =  traderApi;
		this.qdpUserInfo = userInfoVO;
	}

	@Override
	public void OnFrontConnected() {
		log.info("On Front Connected");
		CQdpFtdcAuthenticateField field = new CQdpFtdcAuthenticateField();
	...
	@Override
	public void OnRspAuthenticate(CQdpFtdcRtnAuthenticateField pRspAuthenticateField, CQdpFtdcRspInfoField pRspInfo,
	 ...
	 */
	@Override
	public void OnRspUserLogout(CQdpFtdcRspUserLogoutField pUserLogout, CQdpFtdcRspInfoField pRspInfo,
								int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Override
	public void OnRspQryInstrument(CQdpFtdcRspInstrumentField pInstrument, CQdpFtdcRspInfoField pRspInfo,
								   int nRequestID, boolean bIsLast) {
		if (pRspInfo != null && pRspInfo.getErrorID() != 0) {
	 ...
	 */
	/*@Override
	public void OnRspQrySettlementInfo(CQdpFtdcSettlementInfoField var1, CQdpFtdcRspInfoField var2, int nRequestID, boolean bIsLast) {
	...
	public void OnRspError(CQdpFtdcRspInfoField var1, int nRequestID, boolean bIsLast) {
		...
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		Integer requestId = nRequestID;
		Boolean isLast = bIsLast;
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.ERR, errorRespVO, null, requestId, isLast);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	...
	public void OnErrRtnOrderAction(
			CQdpFtdcOrderActionField var1, CQdpFtdcRspInfoField var2) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		if (null != var1) {
			...
			inputOrderActionRespVO.setOrderActionRef(var1.getUserOrderActionLocalID());
			inputOrderActionRespVO.setOrderRef(String.valueOf(var1.getUserOrderLocalID()));
		...
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.ERR_RTN_ORDER_ACTION, inputOrderActionRespVO, respInfoVO, null, null);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	...
	public void OnRspOrderAction(
		...
		if (null != var1) {
			...
			inputOrderActionRespVO.setOrderActionRef(var1.getUserOrderActionLocalID());
			inputOrderActionRespVO.setOrderRef(String.valueOf(var1.getUserOrderLocalID()));
			//inputOrderActionRespVO.setRequestID(nRequestID);
			inputOrderActionRespVO.setFrontID(var1.getFrontID());
			inputOrderActionRespVO.setSessionID(var1.getSessionID());
			inputOrderActionRespVO.setExchangeID(var1.getExchangeID());
			inputOrderActionRespVO.setOrderSysID(var1.getOrderSysID());
		...
		Boolean isLast = bIsLast;
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.ORDER_ACTION, inputOrderActionRespVO, respInfoVO, requestId, isLast);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	...
	public void OnErrRtnOrderInsert(
			CQdpFtdcInputOrderField var1, CQdpFtdcRspInfoField var2) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		if (null != var1) {
			...
			inputOrderRespVO.setOrderRef(String.valueOf(var1.getUserOrderLocalID()));
			...
			inputOrderRespVO.setCombOffsetFlag(String.valueOf(var1.getOffsetFlag()));
			inputOrderRespVO.setCombHedgeFlag(String.valueOf(var1.getHedgeFlag()));
			inputOrderRespVO.setLimitPrice(var1.getLimitPrice());
			inputOrderRespVO.setVolumeTotalOriginal(var1.getVolume());
			...
			inputOrderRespVO.setUserForceClose(Integer.valueOf(var1.getForceCloseReason()));
			inputOrderRespVO.setIsSwapOrder(var1.getIsAutoSuspend());
		...
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.ERR_RTN_ORDER_INSERT, inputOrderRespVO, respInfoVO, null, null);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	 ...
	 */
	@Override
	public void OnRspQryInvestorAccount(
			CQdpFtdcRspInvestorAccountField var1, CQdpFtdcRspInfoField var2,
			int nRequestID, boolean bIsLast) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		Boolean isLast = bIsLast;
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.QRY_TRADING_ACCOUNT, qryTradingAccountRespVO, respInfoVO, requestId, isLast);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	 ...
	 */
	@Override
	public void OnRspQryInvestorFee(
			CQdpFtdcInvestorFeeField var1, CQdpFtdcRspInfoField var2,
			int nRequestID, boolean bIsLast) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		if (null != var1) {
			...
			qryInstrumentCommissionRateRespVO.setOpenRatioByMoney(var1.getOpenFeeRate());
			qryInstrumentCommissionRateRespVO.setOpenRatioByVolume(var1.getOpenFeeAmt());
			qryInstrumentCommissionRateRespVO.setCloseRatioByMoney(var1.getOffsetFeeRate());
			qryInstrumentCommissionRateRespVO.setCloseRatioByVolume(var1.getOffsetFeeAmt());
			qryInstrumentCommissionRateRespVO.setCloseTodayRatioByMoney(var1.getOTFeeRate());
			qryInstrumentCommissionRateRespVO.setCloseTodayRatioByVolume(var1.getOTFeeAmt());
		...
		Boolean isLast = bIsLast;
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.QRY_INSTRUMENT_COMMISSION_RATE, qryInstrumentCommissionRateRespVO, respInfoVO, requestId, isLast);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	 ...
	 */
	@Override
	public void OnRtnOrder(CQdpFtdcOrderField pRtnOrder) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		if (null != pRtnOrder) {
			...
			rtnOrderRespVO.setOrderRef(String.valueOf(pRtnOrder.getUserOrderLocalID()));
			...
			rtnOrderRespVO.setCombOffsetFlag(String.valueOf(pRtnOrder.getOffsetFlag()));
			rtnOrderRespVO.setCombHedgeFlag(String.valueOf(pRtnOrder.getHedgeFlag()));
			rtnOrderRespVO.setLimitPrice(pRtnOrder.getLimitPrice());
			rtnOrderRespVO.setVolumeTotalOriginal(pRtnOrder.getVolume());
			...
			rtnOrderRespVO.setOrderSubmitStatus(pRtnOrder.getOrderStatus());
			...
			rtnOrderRespVO.setOrderType(pRtnOrder.getOrderPriceType());
			rtnOrderRespVO.setVolumeTraded(pRtnOrder.getVolumeTraded());
			rtnOrderRespVO.setVolumeTotal(pRtnOrder.getVolumeRemain());
			...
			rtnOrderRespVO.setBranchID(String.valueOf(pRtnOrder.getBranchID()));
		...
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.RTN_ORDER, rtnOrderRespVO, null, null, null);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);

		TradeProxyOnFuncMsgHandleEnum.RTN_ORDER.postHandle(rtnOrderRespVO);
	}
	 ...
	 */
	@Override
	public void OnRtnTrade(CQdpFtdcTradeField pRtnTrade) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		if (null != pRtnTrade) {
			...
			rtnTradeRespVO.setOrderRef(String.valueOf(pRtnTrade.getUserOrderLocalID()));
			...
			rtnTradeRespVO.setPrice(pRtnTrade.getTradePrice());
			rtnTradeRespVO.setVolume(pRtnTrade.getTradeVolume());
		...
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.RTN_TRADE, rtnTradeRespVO, null, null, null);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);

		TradeProxyOnFuncMsgHandleEnum.RTN_ORDER.postHandle(rtnTradeRespVO);
	}
	...
	public void OnRspQryInvestorPosition(
			CQdpFtdcRspInvestorPositionField var1, CQdpFtdcRspInfoField var2,
			int nRequestID, boolean bIsLast) {
		MsgHandlerTask qdpMsgHandlerTask = new MsgHandlerTask();
		...
		if (null != var1) {
			...
			qryInvestorPositionDetailRespVO.setVolume(var1.getPosition());
		...
		Boolean isLast = bIsLast;
		qdpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.QRY_INVESTOR_POSITION_DETAIL, qryInvestorPositionDetailRespVO, respInfoVO, requestId, isLast);
		TradeProxyMsgHandlerThreadPool.execute(qdpMsgHandlerTask);
	}
	 ...
	 */
	//@Override
	//public void OnRspQryTrade(CQdpFtdcTradeField pRtnTrade, CQdpFtdcRspInfoField var2, int nRequestID, boolean bIsLast) {
	//	try {
	 ...
	 * 2024/01/04 10:58:01.
	 */
	public int ReqInsertOrder(CQdpFtdcInputOrderField cThostFtdcInputOrderField) {
	 ...
	 * 2024/01/04 11:07:38.
	 */
	public int ReqOrderAction(CQdpFtdcOrderActionField cThostFtdcInputOrderActionField) {
	 ...
	 * 2024/01/04 11:13:36.
	 */
	public int ReqQryTradingAccount(CQdpFtdcQryInvestorAccountField cThostFtdcQryTradingAccountField) {
		return traderApi.ReqQryInvestorAccount(cThostFtdcQryTradingAccountField, getRequestId());
	}
	 ...
	 * 2024/01/04 11:15:15.
	 */
	public int ReqQryInstrumentCommissionRate(CQdpFtdcQryInvestorFeeField cThostFtdcQryInstrumentCommissionRateField) {
		return traderApi.ReqQryInvestorFee(cThostFtdcQryInstrumentCommissionRateField, getRequestId());
	}

	public int ReqQryInvestorPositionDetail(
			CQdpFtdcQryInvestorPositionField cThostFtdcQryInvestorPositionDetailField) {
		return traderApi.ReqQryInvestorPosition(cThostFtdcQryInvestorPositionDetailField, getRequestId());
	}

	public int ReqQryTrade(CQdpFtdcQryTradeField cThostFtdcQryTradeField) {

package com.xinqi.puppet.netty.gateway.tcp.server.proxy.trader.ctpmini;
...
import ctpmini.thosttraderapi.CThostFtdcInstrumentCommissionRateField;
import ctpmini.thosttraderapi.CThostFtdcInstrumentField;
import ctpmini.thosttraderapi.CThostFtdcInvestorPositionDetailField;
import ctpmini.thosttraderapi.CThostFtdcOrderActionField;
import ctpmini.thosttraderapi.CThostFtdcOrderField;
...
import ctpmini.thosttraderapi.CThostFtdcQrySettlementInfoConfirmField;
import ctpmini.thosttraderapi.CThostFtdcQrySettlementInfoField;
import ctpmini.thosttraderapi.CThostFtdcQryTradeField;
import ctpmini.thosttraderapi.CThostFtdcQryTradingAccountField;
import ctpmini.thosttraderapi.CThostFtdcReqAuthenticateField;
import ctpmini.thosttraderapi.CThostFtdcReqUserLoginField;
import ctpmini.thosttraderapi.CThostFtdcRspAuthenticateField;
import ctpmini.thosttraderapi.CThostFtdcRspInfoField;
import ctpmini.thosttraderapi.CThostFtdcRspUserLoginField;
import ctpmini.thosttraderapi.CThostFtdcSettlementInfoConfirmField;
import ctpmini.thosttraderapi.CThostFtdcSettlementInfoField;
import ctpmini.thosttraderapi.CThostFtdcTradeField;
import ctpmini.thosttraderapi.CThostFtdcTraderApi;
import ctpmini.thosttraderapi.CThostFtdcTradingAccountField;
import ctpmini.thosttraderapi.CThostFtdcUserLogoutField;
import ctpmini.thosttraderapi.CThostFtdcTraderSpi;
 ...
 * @since : 2025/6/16 11:01
 **/
@Slf4j
public class CTPMINITradeSpiImpl extends CThostFtdcTraderSpi implements ServletContextListener {
	...
	public CTPMINITradeSpiImpl(CThostFtdcTraderApi traderapi, UserInfoVO ctpUserInfo) {
	...
	public void OnRspQrySettlementInfo(CThostFtdcSettlementInfoField var1, CThostFtdcRspInfoField var2, int nRequestID, boolean bIsLast) {
		...
		ctpMsgHandlerTask.loading(TradeProxyOnFuncMsgHandleEnum.QRY_SETTLEMENT_INFO, qrySettlementInfoRespVO, respInfoVO, requestId, isLast);
	...
	public void OnRspSettlementInfoConfirm(
		...
		Boolean isLast = bIsLast;
		ctpMsgHandlerTask.loading(
				TradeProxyOnFuncMsgHandleEnum.SETTLEMENT_INFO_CONFIRM, settlementInfoConfirmRespVO, respInfoVO, requestId, isLast);
		TradeProxyMsgHandlerThreadPool.execute(ctpMsgHandlerTask);
	}*/
	...
	public void OnRspQrySettlementInfoConfirm(
		...
		try {
			...
			ctpMsgHandlerTask.loading(
					TradeProxyOnFuncMsgHandleEnum.QRY_SETTLEMENT_INFO_CONFIRM, qrySettlementInfoRespVO, respInfoVO, requestId, isLast);
			TradeProxyMsgHandlerThreadPool.execute(ctpMsgHandlerTask);
		} catch (Exception e) {
			log.error("", e);
		}
	...
	public void OnRspQryTrade(CThostFtdcTradeField pRtnTrade, CThostFtdcRspInfoField var2, int nRequestID, boolean bIsLast) {
		try {
			...
			ctpMsgHandlerTask.loading(
					TradeProxyOnFuncMsgHandleEnum.QRY_TRADE, rtnTradeRespVO, respInfoVO, nRequestID, bIsLast);
			TradeProxyMsgHandlerThreadPool.execute(ctpMsgHandlerTask);
		} catch (Exception e) {
			log.error("查询成交记录", e);
		}

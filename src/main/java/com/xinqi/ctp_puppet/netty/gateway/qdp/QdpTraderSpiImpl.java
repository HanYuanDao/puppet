package com.xinqi.ctp_puppet.netty.gateway.qdp;
 ...
 **/
@Slf4j
public class QdpTraderSpiImpl extends CQdpFtdcTraderSpi implements ServletContextListener {
	...
	public QdpTraderSpiImpl(CQdpFtdcTraderApi traderApi, UserInfoVO userInfoVO) {
